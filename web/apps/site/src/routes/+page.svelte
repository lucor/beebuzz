	...
	<div class="mx-auto flex min-h-dvh max-w-7xl flex-col px-4 sm:px-6 lg:px-8">
		...
		<main class="flex-1 pb-16">
			<section class="py-12 md:py-16 lg:py-20">
				<div>
					<h1
						class="text-3xl font-bold leading-snug text-base-content md:text-4xl lg:text-5xl"
					>
					...
					<div>
						...
						>
							...
							<div class="flex w-full flex-col items-center gap-3">
								<div class="mockup-browser w-full border border-base-300 border-t-primary border-t-2 bg-base-100">
			...
			<section class="py-10">
				...
				<div class="grid gap-5 lg:grid-cols-3">
					...
					<div class="rounded-3xl border border-base-300 bg-base-100 p-6 shadow-sm">
						...
						<p class="mt-3 text-sm leading-7 text-base-content/70">
							Notifications from scripts, deployments, and pipelines. Use webhooks, cURL, or the HTTP
							API.
						</p>
					</div>
