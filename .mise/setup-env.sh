...
# VITE_BEEBUZZ_DOMAIN is no longer needed — domain is derived from BEEBUZZ_DOMAIN
# via Vite config's define block. This block only syncs for backward compatibility.
